...
public class EMFResourceSetInitializerTestHelper {
	...
	public static void initEMF() {
		...
		registry.getExtensionToFactoryMap().put(TestHelperConfiguration.REPOSITORY_EXTENSION, new RepositoryResourceFactoryImpl());
		registry.getExtensionToFactoryMap().put(TestHelperConfiguration.RESOURCE_ENVIRONMENT_EXTENSION, new ResourceenvironmentResourceFactoryImpl());
		registry.getExtensionToFactoryMap().put(TestHelperConfiguration.SYSTEM_EXTENSION,	new SystemResourceFactoryImpl());
		registry.getExtensionToFactoryMap().put(TestHelperConfiguration.ALLOCATION_EXTENSION,	new AllocationResourceFactoryImpl());
		registry.getExtensionToFactoryMap().put(TestHelperConfiguration.RESOURCETYPE_EXTENSION, new ResourcetypeResourceFactoryImpl());
		registry.getExtensionToFactoryMap().put(TestHelperConfiguration.USAGEMODEL_EXTENSION, new UsagemodelResourceFactoryImpl());
...
//        , SeffReliabilityPackage.eINSTANCE
		...
		uriMap.put(URI.createURI(TestHelperConfiguration.PALLADIO_RESOURCETYPES_PATHMAP), URI.createURI(TestHelperConfiguration.PALLADIO_RESOURCETYPES_PATHMAP_TARGET));
		uriMap.put(URI.createURI(TestHelperConfiguration.PRIMITIVE_TYPES_REPO_PATHMAP), URI.createURI(TestHelperConfiguration.PRIMITIVE_TYPES_REPO_PATHMAP_TARGET));
		
		// map platform URIs to file URIs to run in standalone mode
//		uriMap.put(TestHelperConfiguration.allocationPlatformUri, TestHelperConfiguration.allocationFileUri);
		uriMap.put(TestHelperConfiguration.usageModelPlatformUri, TestHelperConfiguration.usageModelFileUri);
	}
