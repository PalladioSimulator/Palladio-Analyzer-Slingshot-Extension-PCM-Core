...
public interface ExtensionPointHandler<Provider> {
	...
	/**
	 * An ExtensionPoint as defined in Slingshot always has a child that is
	 * referring to a class that implements the interface.
	 * 
	 * @return The child node of the extension point referring to the class
	 *         implementation.
	 */
