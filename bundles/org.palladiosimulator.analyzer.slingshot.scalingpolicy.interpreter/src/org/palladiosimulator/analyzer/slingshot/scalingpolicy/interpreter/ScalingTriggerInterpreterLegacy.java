...
@Deprecated
public class ScalingTriggerInterpreterLegacy extends ScalingtriggerSwitch<Set<AbstractTriggerEvent>> {
	...
	private final Monitor monitor = null; // TODO

	public ScalingTriggerInterpreterLegacy(final ScalingPolicy parent, final SimulationInformation information) {
		this.parent = parent;
	...
	public Set<AbstractTriggerEvent> caseCPUUtilizationTrigger(final CPUUtilizationTrigger object) {
		...
		// TODO: Check if MeasuringPoint points to a CPU trigger and get its measuring value.
